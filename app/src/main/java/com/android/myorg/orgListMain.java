 ...
 */
public class orgListMain extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener=new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                orgListMain.this.amh=settings.getBoolean("amh_values",true);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent i=new Intent(orgListMain.this,MainActivity.class);
            startActivity(i);
        } else if (id == R.id.Catagorie) {
            Intent i=new Intent(orgListMain.this,cataListMain.class);
            startActivity(i);
            onPause();
        } else if (id == R.id.businesses) {

        } else if (id == R.id.favorites) {
          Intent i=new Intent(orgListMain.this,favuarit.class);
            startActivity(i);
            onPause();
            ...
            Intent i=new Intent(orgListMain.this,credits.class);
            startActivity(i);
            onPause();
        }
...
//                    logo=finalobject.getString("logo");
                    ...
                    updateOrg=dataSource.updatebra(bra_id+"",org_name,tel,fax,po_box,email,street_name,address,city,country,logo,cata_id+"",visibility,latitude,longitude);
                    if (updateOrg==0)
