 ...
 */
public class cataListMain extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener=new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                cataListMain.this.amh=settings.getBoolean("amh_values",true);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent i=new Intent(cataListMain.this,MainActivity.class);
            startActivity(i);
            onPause();
        } else if (id == R.id.Catagorie) {

        } else if (id == R.id.businesses) {
            Intent i=new Intent(cataListMain.this,orgListMain.class);
            startActivity(i);
            onPause();
            ...
            Intent i=new Intent(cataListMain.this,credits.class);
            startActivity(i);
            onPause();
        }
